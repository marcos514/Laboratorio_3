...
function mostrar1() {
    var ajax7 = new Ajax();
    ajax7.Post("traerAuto.php", function (mostrar) {
        var json = JSON.parse(mostrar);
        document.getElementById("txtId").value = json.Id;
        document.getElementById("txtMarca").value = json.Marca;
        document.getElementById("txtPrecio").value = json.Precio;
